...
String strhtml="<html><head><meta http-equiv=\"Content-Language\" content=\"en-ca\"><meta name=\"viewport\" content=\"width=device-width, user-scalable=no\"head>" ;
	   ...
	   strhtml = strhtml + "<tr><td width=\"148\"><font color=\"#FF0000\">&nbsp;&nbsp;*</font>Device ID</td><td width=\"188\"><input type=\"text\" name=\"mqttID\" id=\"mqttID\" required></td></tr>";
	   ...
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;MQTT Enabled</td><td width=\"188\"><input type=\"checkbox\" name=\"MQTT\" value=\"ON\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;MQTT IP</td><td width=\"188\"><input type=\"text\" name=\"mqttIP\" id=\"mqttIP\" size=\"12\"></td></tr>";
	   ...
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Static IP</td><td width=\"188\"><input type=\"text\" name=\"staticIP\" id=\"staticIP\" size=\"12\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Gateway</td><td width=\"188\"><input type=\"text\" name=\"gateway\" id=\"gateway\" size=\"12\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Subnet</td><td width=\"188\"><input type=\"text\" name=\"subnet\" id=\"subnet\" size=\"12\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;DNS</td><td width=\"188\"><input type=\"text\" name=\"DNS\" id=\"DNS\" size=\"12\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;MAC</td><td width=\"188\"><input type=\"text\" name=\"MAC\" id=\"MAC\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Enable UPnP</td><td width=\"188\"><input type=\"checkbox\" name=\"UPnP\" value=\"ON\"></td></tr>";
	   ...
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Enable SSL</td><td width=\"188\"><input type=\"checkbox\" name=\"SSL\" value=\"ON\"></td></tr>";
	   strhtml = strhtml + "<tr><td width=\"148\">&nbsp;&nbsp;Certificate Path</td><td width=\"188\"><input type=\"text\" name=\"CertPath\" size=\"25\"></td></tr>";
